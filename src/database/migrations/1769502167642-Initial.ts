...
export class Initial1769502167642 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."tracks_status_enum" AS ENUM('uploaded', 'processing', 'ready', 'failed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_subscriptionplan_enum" AS ENUM('free', 'pro')`);
